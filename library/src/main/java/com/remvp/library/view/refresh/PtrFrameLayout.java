...
import com.remvp.library.view.refresh.indicator.PtrIndicator;
import com.remvp.library.view.refresh.util.PtrCLog;

import java.util.ArrayList;


/**
 * Created by jyp on 2017/9/27.
 */
...
//                if (mDisableWhenHorizontalMove && (Math.abs(offsetX) > mPagingTouchSlop && Math.abs(offsetX) > Math.abs(offsetY * (canMoveUp ? mPtrIndicator.getResistanceHeader() : mPtrIndicator.getResistanceFooter())))) {
//                    return dispatchTouchEventSupper(e);
//                }
